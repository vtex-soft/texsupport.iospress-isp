...
References should be collected at the end of your paper (environment\break
...
with DVIPS version 5.56 or higher. The option\break "-M" (don't make fonts) should be indicated.
